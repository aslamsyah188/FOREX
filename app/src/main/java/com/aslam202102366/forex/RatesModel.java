package com.aslam202102366.forex;

public class RatesModel
{
    private double USD, IDR, BTC, KRW, MYR, SAR, SGD, THB, TRY, SEK;
    ...
    public void setBTC(double JPY) { this.BTC =JPY; }
    ...
    public void seSGD(double SGD) { this.SGD =SGD; }
